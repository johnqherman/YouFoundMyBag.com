...
export const securityHeaders = helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", 'https://challenges.cloudflare.com', 'https://api.stripe.com', 'https://m.stripe.com', 'https://m.stripe.network', 'https://q.stripe.com'],
      frameSrc: ["'self'", 'https://challenges.cloudflare.com', 'https://js.stripe.com', 'https://hooks.stripe.com', 'https://m.stripe.network'],
      frameAncestors: ["'self'"],
      objectSrc: ["'none'"],
      baseUri: ["'self'"],
      formAction: ["'self'"],
